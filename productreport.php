...
<head>
    ...
    <title> PRODUCT REPORT | SURECELL</title>
    <!-- favicon -->
...
<body>
    ...
    <div class="content">
        ...
        <div class="details">
            ...
            <button class="box-button" onclick="location.href='selleracc.php?S_ID=<?php echo $row['seller_id'];?>';">VIEW SELLER</button>
        </div>
    </div>
    ...
    ?>
        ...
        <div class="row">
            ...
            <div class="align">
                ...
                <div class="deletebtn">
                    <form action="deletepro.php?ID='$pid'">
                    <button class="deletead">DELETE AD</button>
                    </form>
                </div>
            </div>
        </div>
