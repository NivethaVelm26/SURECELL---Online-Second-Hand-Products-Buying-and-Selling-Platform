...
<body>
    ...
    <div class="content">
        ...
        <h1 class="name"><?php echo $row['p_name'] ?></h1>
            ...
            <button class="box-button" onclick="viewselleracc()">VIEW SELLER</button>
        </div>
    </div>
    <div class="exrev">
        <div class="revhead">
        ...
        <div class="row">
            <div class="box">
                ...
                <div class="inbox">
                    <form action="sub.php?ID='$pid'" method="post">
                        <input id="w3review" name="w3review" rows="4" cols="50">
                        <button class="submitbtn">SUBMIT REVIEW</button>
                        <button class="reportbtn">REPORT AD</button>
                    </form>
                </div>
            </div>
            </div>
            <div class="exarea">
                <div class="sellerimg">
                    <img src="img/<?php echo $row2['img'] ?>.jpg">
                </div>
                <div class="deets">
