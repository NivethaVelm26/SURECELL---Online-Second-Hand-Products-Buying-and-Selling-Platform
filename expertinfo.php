...
<body>
    ...
    <h1 class="req">ALL EXPERTS INFO :</h1>
	<div class="rect">
        <div class="division">EXPERT IMG</div>
		<div class="division">EXPERT ID</div>
        <div class="division">EXPERT NAME</div>
		<div class="division">QUALIFICATION</div>
		<div class="division">SPECIALIZATION</div>
        <div class="division">LANGUAGES</div>
		<div class="division">LOCATION</div>
        <div class="division">EDIT</div>
	</div>
    <div class="entry">
        <?php
        ...
        <div class="rectangle">
            <div class="expp">
                <img src="img/<?php echo $row['img']?>.jpg" class="imgexpp">
            </div>
            <div class="exid"><?php echo $row['ex_id']?></div>
            <div class="exname"><?php echo $row['ex_name']?></div>
            <div class="exqual"><?php echo $row['qualification']?></div>
            <div class="exspec"><?php echo $row['spec']?></div>
            <div class="exlang"><?php echo $row['lang']?></div>
            <div class="exloc"><?php echo $row['location']?></div>
            <div class="division">
